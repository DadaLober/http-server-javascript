...
import { handleEchoRequest, handleUserAgentRequest, handleRequests, handleDefaultRequest, handlePOSTRequests } from "./routerHandler.js";
...
export const routes = {
	...
	'/files': (directory, path, headers, file, requestLine, body) => requestLine.includes('POST') ? handlePOSTRequests(directory, file, body) : handleRequests(directory, file),
};